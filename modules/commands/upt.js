const fbname = "100001526796949";
const githubname = "github.com/nvp-jailbreak";
...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    ctx.fillText("@" + "nvp_vanphuoc", 930, 540)
    ctx.fillText("@" + "@nvp-jailbreak", 930, 610)
    ctx.fillText("@" + "100001526796949", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
