module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "Mirai Team Mod By NVP", // fix DuyVuong
...
🌟𝐒𝐮̛̉ 𝐝𝐮̣𝐧𝐠: "${prefix}𝗵𝗲𝗹𝗽 + 𝘁𝗲̂𝗻 𝗹𝗲̣̂𝗻𝗵" 𝗰𝗵𝗼 𝗯𝗶𝗲̂́𝘁 𝗰𝗵𝗶 𝘁𝗶𝗲̂́𝘁 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗹𝗲̣̂𝗻𝗵
💝𝐁𝐨𝐭 𝐤𝐡𝐨̛̉𝐢 𝐜𝐡𝐚̣𝐲 𝐛𝐨̛̉𝐢 𝑵𝒈𝒖𝒚𝒆̂̃𝒏 𝑽𝒂̆𝒏 𝑷𝒉𝒖̛𝒐̛́𝒄
[💝] 𝐓𝐫𝐞̂𝐧 𝐋𝐚̀ 𝐓𝐨𝐚̀𝐧 𝐁𝐨̣̂ 𝐋𝐞̣̂𝐧𝐡 𝐂𝐨́ 𝐓𝐫𝐨𝐧𝐠 𝐅𝐢𝐥𝐞 𝐁𝐨𝐭 𝐂𝐮̉𝐚 𝑵𝒈𝒖𝒚𝒆̂̃𝒏 𝑽𝒂̆𝒏 𝑷𝒉𝒖̛𝒐̛́𝒄. [❗]
🔰𝗩𝘂𝗶 𝗟𝗼̀𝗻𝗴 𝗞𝗵𝗼̂𝗻𝗴 𝗦𝗽𝗮𝗺 𝗕𝗼𝘁  [❗]`;
    return axios.get('https://apikanna.khoahoang3.repl.co/').then(res => {
    let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
...
✎﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏
💓 𝐐𝐮𝐚̉𝐧 𝐋𝐲́ 𝐁𝐨̛̉𝐢 𝑵𝒈𝒖𝒚𝒆̂̃𝒏 𝑽𝒂̆𝒏 𝑷𝒉𝒖̛𝒐̛́𝒄 🐉`,
