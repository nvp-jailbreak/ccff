...
"https://i.imgur.com/yRBuo11.jpg",
 ...
 "https://i.imgur.com/CddZAzl.jpg",
 "https://i.imgur.com/xybY4J6.jpg",
 "https://i.imgur.com/R9CZE1a.jpg", 
 "https://i.imgur.com/VELaDGC.jpg",
 "https://i.imgur.com/sxzEwCz.jpg",
 "https://i.imgur.com/AztKV4S.jpg",
 "https://i.imgur.com/2UKFGBw.jpg",
 "https://i.imgur.com/d3h5q7v.jpg",
  ];
  ...
  var money = data.money
      if(money < 20000) api.sendMessage("Bạn cần 20000 đô để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 20000})
   var callback = () => api.sendMessage({body:`Suốt ngày dú dú😼\n» Số dư: -20000 đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
