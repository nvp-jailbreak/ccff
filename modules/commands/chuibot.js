...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Thông báo từ Admin«\n\n${c}, Bạn thật ngu ngok khi chửi bot vì vậy bot đã tự động ban bạn khỏi hệ thống vĩnh viễn\nThả tym cho bạn nè <3`
	};
    //Thêm các câu chửi vào ko viết Hoa
	["botngu", "bot ngu", "bot gà", "con bot lol", "bot ngu lol", "bot chó", "dm bot", "đm bot", "dmm bot", "dmm bot", "đmm bot", "đb bot", "bot điên", "bot dở", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "phước ngu", "bot shoppee", "bot đểu", "bot dỡm","Bot nứng","bot ncc","bot xàm lồn","bot như chó","bot súc vật","bot bú lồn","bot phế","bot óc lồn","bot óc cặk","bot ngu vcl","sv bot","bot sv","bot súc vật"].forEach((a => {
