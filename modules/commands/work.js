...
var coinscn = Math.floor(Math.random() * 5000) + 1000; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 40000) + 5000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 70000) + 5000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 8000) + 5000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 5000) + 1000; //random coins khi đào đá
