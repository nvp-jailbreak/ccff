...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "cave.png")) request("https://i.imgur.com/76WZ5Eu.jpg").pipe(fs.createWriteStream(dirMaterial + "cave.png"));
}
...
module.exports.run = async ({  
    ...
    if (typeof data !== "undefined" && cooldown - (Date.now() - data.work2Time) > 0) {
        ...
        return api.sendMessage(`💎𝐁𝐚̣𝐧 đ𝐚̃ 𝐥𝐚̀𝐦 𝐜𝐚𝐯𝐞 𝐯𝐚̀ 𝐛𝐚̣𝐧 đ𝐚̃ 𝐡𝐞̂́𝐭 𝐯𝐨̂́𝐧 𝐭𝐮̛̣ 𝐜𝐨́ 𝐛𝐚̣𝐧 𝐯𝐮𝐢 𝐥𝐨̀𝐧𝐠 𝐪𝐮𝐚𝐲 𝐥𝐚̣𝐢 𝐬𝐚𝐮 🎋.`, e.threadID, e.messageID); // Đoạn này ae có thể để quay lại sau ${housr}giờ ${minutes}phút ${seconds}giây
    }
    else {    
        var msg = {
